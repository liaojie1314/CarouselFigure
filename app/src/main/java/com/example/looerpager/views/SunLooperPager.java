package com.example.looerpager.views;
...
import com.example.looerpager.R;

public class SunLooperPager extends LinearLayout {

    private static final String TAG = "SunLooperPager";
    private SunViewPager mViewPager;
    ...
    public SunLooperPager(Context context) {
        this(context, null);
    }

    public SunLooperPager(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SunLooperPager(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
...
//        addView(item);
    ...
    private void initEvent() {
        mViewPager.setPagerItemClickListener(new SunViewPager.OnPagerItemClickListener() {
            @Override
